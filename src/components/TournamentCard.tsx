...
export default function TournamentCard({ tournament, pickCount, totalPicks }: Props) {
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-6 hover:border-green-400 transition-colors shadow-sm">
      ...
      <div className="flex gap-3 mt-5">
        ...
        <Link
          ...
          className="flex-1 text-center bg-gray-100 text-gray-700 py-2 px-4 rounded-lg text-sm font-medium hover:bg-gray-200 transition-colors"
        >
          Leaderboard
        </Link>
      </div>
