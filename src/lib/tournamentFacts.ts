...
const FACTS: Record<string, TournamentFacts> = {
  ...
  'pga championship': {
    ...
    access: 'Private',
    founded: 1916,
    designer: 'George Cobb (renovated by Tom Fazio)',
    funFact: 'The PGA Championship is the only major where the defending champion automatically qualifies the following year.',
  },
  'us open': {
    ...
    funFact: 'Pinehurst No. 2 is the only course to have hosted the US Open, US Amateur, and PGA Championship.',
  },
  'u.s. open': {
    course: 'Pinehurst No. 2',
    location: 'Pinehurst, NC',
